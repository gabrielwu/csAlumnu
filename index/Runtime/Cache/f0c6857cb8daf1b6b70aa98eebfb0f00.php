...
KindEditor.ready(function(K) {
	...
	$("#type option").each(function () {
	    if ($(this).val() == <?php echo ($data['type']); ?> ) {
...
<div id="right">
    <div class="title">
    	<span>新闻通知</span> — <span>编辑通知</span>
	</div>
	<div class="content2">
	    <form action="<?php echo ($url); ?>/edit" method="post" id="form" target="main">
		    <input class="inputL" type="hidden" name="id" id="id" value="<?php echo ($data['id']); ?>"/>
			<div class="common">
				<table>
					<tr>
						<td><span>标题</span></td>
					...
					<tr>
						<td><input class="inputL" name="title" id="title" value="<?php echo ($data['title']); ?>"/></td>
						<td>
			...
			<div class="common">
				<span>内容</span></br>
				<textarea name="content" id="content" style="width:800px;height:400px;visibility:hidden;"><?php echo ($data['content']); ?></textarea>
			</div>
			<div class="common">

...
<link href="<?php echo ($datatables); ?>/css/jquery.dataTables.css" rel="stylesheet" type="text/css" />
<link href="<?php echo ($datatables); ?>/css/demo_page.css" rel="stylesheet" type="text/css" />
<link href="<?php echo ($datatables); ?>/css/demo_table.css" rel="stylesheet" type="text/css" />
<link href="<?php echo ($datatables); ?>/css/jquery.dataTables_themeroller.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo ($datatables); ?>/js/jquery.dataTables.min.js"></script>
...
<div id="right">
    <div class="title">
    	<span>查询事务</span> — <span>在读生</span>
    </div>
	<div class="search">
	    <form action="<?php echo ($url); ?>/queryAll" method="post" id="form">
    	    <table id="tb_s">
    	    	<tr>

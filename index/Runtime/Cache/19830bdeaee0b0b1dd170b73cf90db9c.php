...
<div id="right">
    <div class="title">
    	<span>新闻通知</span> — <span>发布通知</span>
    	<a id="a_" href="#">发布通知</a>
    	<a id="a_" class="current" href="#">发布通知</a>
	</div>
	<div class="content2">
					...
					<tr>
						...
						<td>
							<select class="input"  name="type" id="type">
								<?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type_list): ++$i;$mod = ($i % 2 )?><option value="<?php echo ($type_list["id"]); ?>"><?php echo ($type_list["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</td>
					</tr>
				</table>
